...
const ReviewSection = () => {
  ...
  const getAvatar = (review) => {
    if (review.profile_image) return review.profile_image;
            ...
            <div className="max-w-3xl mx-auto">
              ...
              <form onSubmit={handleSubmit} className="space-y-5 sm:space-y-6">
                ...
                <button
                  type="submit"
                  disabled={submitting}
                  className="w-full bg-[#B38F6F] text-white font-bold py-3.5 sm:py-4 rounded-xl shadow-lg hover:bg-yellow-600 transition text-sm sm:text-base"
                >
                  {submitting ? (
